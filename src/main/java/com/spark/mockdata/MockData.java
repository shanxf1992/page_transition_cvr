...
public class MockData {
    ...
    public static void mock(SparkSession spark) {
        ...
        //df.toJavaRDD().saveAsTextFile("C:\\git_projects\\user_visit_action");
        df.show(10);
        ...
        Dataset<Row> df2 = spark.createDataFrame(rowsRDD, schema2);
        //打印
        df2.show(10);

        df2.createOrReplaceTempView("user_info");
        df2.toJavaRDD().saveAsTextFile("C:\\git_projects\\user_visit_action");
    }
}
